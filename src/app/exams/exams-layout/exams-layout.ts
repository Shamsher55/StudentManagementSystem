...
@Component({
  ...
  templateUrl: './exams-layout.html',
  styleUrl: './exams-layout.css',
})
export class ExamsLayout implements OnInit {
  ...
  get navItems() {
    ...
    return [
      ...
      ...(isAdmin || isSuperAdmin ? [{ label: 'Schedule Exam',  icon: '➕', route: '/exams/add' }] : []),
